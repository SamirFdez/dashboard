                ...
                <Col
                  ...
                  className={
                    colaborador.ERROR === 1
                      ...
                      : colaborador.ERROR === 2
                      ? EstacionesCardsStyles.cardGreen
                      : colaborador.ERROR === 3
                      ? EstacionesCardsStyles.cardBlue
                      : colaborador.ERROR === 4
                      ? EstacionesCardsStyles.cardGreenSpecial
                      : EstacionesCardsStyles.cardGray
                  }
                >
                  <Row className={EstacionesCardsStyles.rowImgName}>
                    <Col xs={4}>
                      <img
                        src={`data:image/jpeg;base64,${colaborador.Foto}`}
                      ...
                      {colaborador.ERROR === 3 ? (
                        <>
                          ...
                          {colaborador.Notificacion_24h === 0 ? (
                            <TiempoNotificado
                              colaborador={colaborador.TiempoNotificacion}
                            />
                          ) : (
                            <h4
                              style={{ marginTop: "0.2em", color: "#dc3545" }}
                            >
                              {" "}
                              Más de un día{" "}
                            </h4>
                  ...
                  <Row
                    className={EstacionesCardsStyles.rowInfo}
                    style={{ marginTop: "1em" }}
                  >
                    <Col
                      className={EstacionesCardsStyles.rowEstacion}
                      style={{ marginRight: "1em" }}
                    >
                      <h1 style={{ marginTop: "0.2em" }}>
                        {" "}
                        {colaborador.NumeroEstacion}{" "}
                      </h1>
                  ...
                  <Row
                    className={EstacionesCardsStyles.rowPausa}
                    style={{ marginTop: "1em" }}
                  >
                    <Row
                      style={{
                    ...
                    >
                      ...
                      <Col xs={5}>
                        {colaborador.UltEstatus_24h === 0 ? (
                          <TiempoUltimoEstatus
                            colaborador={colaborador.TiempoUltimoEstatus}
                          />
                        ) : (
                          <h4> Más de un día </h4>
                        )}
                  ...
                  <Row
                    className={EstacionesCardsStyles.rowCita}
                    style={{ marginTop: "1em" }}
                  >
                    <Row>
                      <Col>
