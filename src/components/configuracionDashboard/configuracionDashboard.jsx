          ...
          <Container>
            <Row className={configuracionDashboardStyles.formRow}>
              <Col lg={4} md={6} sm={12} xs={12} style={{ marginTop: "1em" }}>
                <label className={configuracionDashboardStyles.labelForm}>
            ...
            <Row
              className={configuracionDashboardStyles.formGroup}
            ...
            >
              ...
              <Col lg={8} md={6} sm={12} xs={12} style={{ marginTop: "1em" }}>
                <Dropdown>
                  ...
                  <Dropdown.Menu style={{ fontSize: "1.5em" }}>
                    <Dropdown.Item href="" style={{ fontSize: "1em" }}>
                      <span>
                        <FaSun />
                      </span>
                      Modo light
            ...
            <div style={{ textAlign: "right" }}>
              <Button
                variant="danger"
                style={{ fontSize: "2em", width: "5em", marginRight: "1em" }}
              >
                Cancelar
              </Button>
